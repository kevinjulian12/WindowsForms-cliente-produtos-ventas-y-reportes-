...
Public Class ListasDeClientes
    Dim Core As CoreCliente = New CoreCliente()
    Public entidad As EntidadesClientes = New EntidadesClientes

    Private Sub MostrarClientes()
        dataGridView1.DataSource = Core.Reading(entidad)
    End Sub
    ...
    Private Sub btnSeleccionar_Click(sender As Object, e As EventArgs) Handles btnSeleccionar.Click
        If (dataGridView1.SelectedRows.Count > 0) Then
            ...
            ventas.txtidcliente.Enabled = False
            ventas.txtcliente.Enabled = False
            ventas.txtTelefono.Enabled = False
            ventas.txtcorreo.Enabled = False
            ventas.ClienteCargado = True
            Venta.TabPage2.Enabled = True
            Close()
        Else
